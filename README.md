...
```
cd existing_repo
git remote add origin https://gitlab.vworks.com.vn/vworks/cuongphongled/be-mngt-warehouse.git
git branch -M master
...
- [ ] [Set up project integrations](http://518746a6b1c6/vworks/cuongphongled/be-mngt-warehouse/-/settings/integrations)
